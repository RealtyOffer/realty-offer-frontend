...
export type MarkdownRemarkFieldsEnum = 
  ...
  | 'frontmatter___consumer___icon___sourceInstanceName'
  | 'frontmatter___consumer___icon___absolutePath'
  | 'frontmatter___consumer___icon___relativePath'
  | 'frontmatter___consumer___icon___extension'
  | 'frontmatter___consumer___icon___size'
  | 'frontmatter___consumer___icon___prettySize'
  | 'frontmatter___consumer___icon___modifiedTime'
  | 'frontmatter___consumer___icon___accessTime'
  | 'frontmatter___consumer___icon___changeTime'
  | 'frontmatter___consumer___icon___birthTime'
  | 'frontmatter___consumer___icon___root'
  | 'frontmatter___consumer___icon___dir'
  | 'frontmatter___consumer___icon___base'
  | 'frontmatter___consumer___icon___ext'
  | 'frontmatter___consumer___icon___name'
  | 'frontmatter___consumer___icon___relativeDirectory'
  | 'frontmatter___consumer___icon___dev'
  | 'frontmatter___consumer___icon___mode'
  | 'frontmatter___consumer___icon___nlink'
  | 'frontmatter___consumer___icon___uid'
  | 'frontmatter___consumer___icon___gid'
  | 'frontmatter___consumer___icon___rdev'
  | 'frontmatter___consumer___icon___ino'
  | 'frontmatter___consumer___icon___atimeMs'
  | 'frontmatter___consumer___icon___mtimeMs'
  | 'frontmatter___consumer___icon___ctimeMs'
  | 'frontmatter___consumer___icon___atime'
  | 'frontmatter___consumer___icon___mtime'
  | 'frontmatter___consumer___icon___ctime'
  | 'frontmatter___consumer___icon___birthtime'
  | 'frontmatter___consumer___icon___birthtimeMs'
  | 'frontmatter___consumer___icon___blksize'
  | 'frontmatter___consumer___icon___blocks'
  | 'frontmatter___consumer___icon___publicURL'
  | 'frontmatter___consumer___icon___id'
  | 'frontmatter___consumer___icon___children'
  | 'frontmatter___agent___title'
  | 'frontmatter___agent___body'
  | 'frontmatter___agent___cta'
  | 'frontmatter___agent___icon___sourceInstanceName'
  | 'frontmatter___agent___icon___absolutePath'
  | 'frontmatter___agent___icon___relativePath'
  | 'frontmatter___agent___icon___extension'
  | 'frontmatter___agent___icon___size'
  | 'frontmatter___agent___icon___prettySize'
  | 'frontmatter___agent___icon___modifiedTime'
  | 'frontmatter___agent___icon___accessTime'
  | 'frontmatter___agent___icon___changeTime'
  | 'frontmatter___agent___icon___birthTime'
  | 'frontmatter___agent___icon___root'
  | 'frontmatter___agent___icon___dir'
  | 'frontmatter___agent___icon___base'
  | 'frontmatter___agent___icon___ext'
  | 'frontmatter___agent___icon___name'
  | 'frontmatter___agent___icon___relativeDirectory'
  | 'frontmatter___agent___icon___dev'
  | 'frontmatter___agent___icon___mode'
  | 'frontmatter___agent___icon___nlink'
  | 'frontmatter___agent___icon___uid'
  | 'frontmatter___agent___icon___gid'
  | 'frontmatter___agent___icon___rdev'
  | 'frontmatter___agent___icon___ino'
  | 'frontmatter___agent___icon___atimeMs'
  | 'frontmatter___agent___icon___mtimeMs'
  | 'frontmatter___agent___icon___ctimeMs'
  | 'frontmatter___agent___icon___atime'
  | 'frontmatter___agent___icon___mtime'
  | 'frontmatter___agent___icon___ctime'
  | 'frontmatter___agent___icon___birthtime'
  | 'frontmatter___agent___icon___birthtimeMs'
  | 'frontmatter___agent___icon___blksize'
  | 'frontmatter___agent___icon___blocks'
...
export type MarkdownRemarkFrontmatterAgent = {
...
export type MarkdownRemarkFrontmatterAgentFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  body?: Maybe<StringQueryOperatorInput>;
  cta?: Maybe<StringQueryOperatorInput>;
  icon?: Maybe<FileFilterInput>;
};

export type MarkdownRemarkFrontmatterConsumer = {
  title?: Maybe<Scalars['String']>;
  body?: Maybe<Scalars['String']>;
  cta?: Maybe<Scalars['String']>;
  icon?: Maybe<File>;
...
export type MarkdownRemarkFrontmatterConsumerFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  body?: Maybe<StringQueryOperatorInput>;
  cta?: Maybe<StringQueryOperatorInput>;
  icon?: Maybe<FileFilterInput>;
...
export type MarkdownRemarkFrontmatterMainpitchCardsFilterInput = {
...
export type MarkdownRemarkFrontmatterMainpitchCardsFilterListInput = {
  elemMatch?: Maybe<MarkdownRemarkFrontmatterMainpitchCardsFilterInput>;
};
...
export type MarkdownRemarkFrontmatterMainpitchStepsFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  body?: Maybe<StringQueryOperatorInput>;
  image?: Maybe<FileFilterInput>;
};

export type MarkdownRemarkFrontmatterMainpitchStepsFilterListInput = {
  elemMatch?: Maybe<MarkdownRemarkFrontmatterMainpitchStepsFilterInput>;
};
...
export type MarkdownRemarkFrontmatterThirdpitchFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  text?: Maybe<StringQueryOperatorInput>;
  caption?: Maybe<StringQueryOperatorInput>;
  image?: Maybe<FileFilterInput>;
...
export type BlogRollQueryQuery = { allMarkdownRemark: { edges: Array<{ node: (
        ...
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter: (
...
export type BlogPostByIdQuery = { markdownRemark?: Maybe<(
    ...
    & { frontmatter: Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'description' | 'tags'> }
  )> };

export type IndexPageTemplateQueryVariables = {};


export type IndexPageTemplateQuery = { markdownRemark?: Maybe<{ frontmatter: (
      Pick<MarkdownRemarkFrontmatter, 'title' | 'heroHeading' | 'heroSubheading' | 'heroCTALink' | 'heroCTAText'>
      & { heroImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, mainpitch?: Maybe<(
        Pick<MarkdownRemarkFrontmatterMainpitch, 'title'>
        & { cards?: Maybe<Array<Maybe<(
          Pick<MarkdownRemarkFrontmatterMainpitchCards, 'title' | 'text' | 'link' | 'linkText' | 'linkType'>
          & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, icon?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
        )>>> }
      )>, secondpitch?: Maybe<(
        Pick<MarkdownRemarkFrontmatterSecondpitch, 'title' | 'text' | 'caption' | 'link' | 'linkText' | 'linkType'>
        & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
      )>, thirdpitch?: Maybe<(
        Pick<MarkdownRemarkFrontmatterThirdpitch, 'title' | 'text' | 'caption' | 'link' | 'linkText' | 'linkType'>
        & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
      )> }
    ) }> };

export type LandingPageTemplateQueryVariables = {};


export type LandingPageTemplateQuery = { markdownRemark?: Maybe<{ frontmatter: (
      Pick<MarkdownRemarkFrontmatter, 'title' | 'heroHeading' | 'heroSubheading'>
      & { heroImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, consumer?: Maybe<(
        Pick<MarkdownRemarkFrontmatterConsumer, 'title' | 'body' | 'cta'>
        & { icon?: Maybe<Pick<File, 'publicURL'>> }
      )>, agent?: Maybe<(
        Pick<MarkdownRemarkFrontmatterAgent, 'title' | 'body' | 'cta'>
        & { icon?: Maybe<Pick<File, 'publicURL'>> }
      )>, mainpitch?: Maybe<(
        Pick<MarkdownRemarkFrontmatterMainpitch, 'title'>
        & { steps?: Maybe<Array<Maybe<(
          Pick<MarkdownRemarkFrontmatterMainpitchSteps, 'title' | 'body'>
          & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
        )>>> }
      )>, secondpitch?: Maybe<(
        Pick<MarkdownRemarkFrontmatterSecondpitch, 'title' | 'body' | 'link' | 'linkText'>
        & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
      )> }
    ) }> };
...
export type TagPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: (
    ...
    & { edges: Array<{ node: { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter: Pick<MarkdownRemarkFrontmatter, 'title'> } }> }
  ) };
