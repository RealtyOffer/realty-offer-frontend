...
import {
  Button, Modal, Heading, Row, Column,
} from '../../../components';
...
const UnsavedChangesModal: FunctionComponent<UnsavedChangesModalProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Row>
        <Column xs={6}>
          <Button type="button" onClick={() => props.toggleModal()} color="primaryOutline" block>No</Button>
        </Column>
        <Column xs={6}>
          <Button type="button" onClick={() => clearDataAndNavigate()} block>Yes</Button>
        </Column>
      </Row>
    </Modal>
  );
