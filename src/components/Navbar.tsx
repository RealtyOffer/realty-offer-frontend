...
import {
  baseSpacer, doubleSpacer, octupleSpacer, halfSpacer, screenSizes,
} from '../styles/size';
...
const Navbar: FunctionComponent<NavbarProps> = (props) => {
  ...
  return (
    <StyledNavbar role="navigation" aria-label="main-navigation">
      <PageContainer>
        <FlexContainer justifyContent={props.auth.isLoggedIn && isSmallScreen ? 'center' : 'space-between'}>
                  ...
                  isSmallScreen ? (
                    ...
                    <StyledDropdownWrapper>
                      ...
                      <StyledDropdown>
                        {
                          secondaryNavigation.map((navItem) => (
                            <Link key={navItem.name} to={navItem.path}>{navItem.name}</Link>
                          ))
                        }
                        <Link to="/" onClick={() => props.actions.logout()}>Log Out</Link>
                      </StyledDropdown>
